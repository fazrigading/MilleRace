...
```mermaid
graph TD
    subgraph Character Profiles
        M["🦊 Miller<br/>Curious Explorer<br/>(1–25 pts)"]
        J["⚡ Jen<br/>Energetic Fact-Checker<br/>(26–50 pts)"]
        A["🦉 Aidan<br/>Critical Inquirer<br/>(51–75 pts)"]
        L["🎨 Lizzy<br/>Literary Wiz<br/>(76–100 pts)"]
    end
```
